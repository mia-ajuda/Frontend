...
Bem-vindo aos termos e condições de uso do Mia-Ajuda (“Termos”),. Os Termos abaixo têm importância, pois tratam de:
...
Por favor, esteja confortável e leia com paciência tudo que está disposto nos Termos, e também em nossa Política de Privacidade.
...
Você pode, em nosso aplicativo, realizar pedidos de ajudas, caso tenha alguma necessidade e que você ache que outra pessoa tem a capacidade para lhe ajudar. Além de ofertar ajuda à uma pessoa que tem alguma necessidade, sendo o Mia-Ajuda um aplicativo com propósito colaborativo e ajuda comunitária, sem quaisquer fins lucrativos.

O aplicativo é propriedade do grupo do LESC - Laboratório de Engenharia de Software Colaborativo/LDTEA - FGA S9 e da Equipe desenvolvedora (“Equipe Mia-Ajuda”) Sendo assim nós concedemos a você uma permissão limitada, não exclusiva e revogável para fazer uso do aplicativo Mia-Ajuda de forma pessoal e intransferível (coletivamente, “Acesso”). Este Acesso permanecerá em vigor, a menos que seja encerrado por você. Você promete e concorda que você está usando o Mia-Ajuda e suas ajudas para seu próprio uso pessoal, não comercial e que você não irá transferir ajudas de sua propriedade para outrem, e nem delegar a outrem as ofertas de ajudas feitas por você. O aplicativo de software Mia-Ajuda não são vendidos nem transferidos para você, e o LESC retêm a titularidade de todas as cópias dos aplicativos de software Mia-Ajuda, mesmo após a instalação em suas telefones celulares, tablets, e outros dispositivos (“Dispositivos”).

Todas as marcas, nomes comerciais, logotipos, nomes de domínio do Mia-Ajuda e quaisquer outras características da marca Mia-Ajuda (“Características da Marca Mia-Ajuda”) são propriedade exclusiva da Equipe Mia-Ajuda. Os Acordos não concedem a você quaisquer direitos de usar quaisquer Características da Marca Mia-Ajuda seja para uso comercial ou não comercial.

Você concorda em respeitar nossas Diretrizes do Usuário e não usar o Mia-Ajuda, de qualquer forma não expressamente permitida pelos Acordos. Exceto pelos direitos expressamente concedidos a você nos Acordos, o Mia-Ajuda não concede qualquer direito, título ou interesse a você relativos ao projeto.

## 4. Conteúdo Gerado pelo Usuário

Os usuários do Mia-Ajuda podem postar, carregar ou contribuir de forma diversa com pedidos de ajudas e necessidades variadas. Esses pedidos são compostos por título, descrição e categoria específica, ou seja, o Conteúdo.Para esclarecimento, o “Conteúdo” inclui qualquer pedido postado pelos usuários.

Você promete que, no que concerne a qualquer Conteúdo que você postar no Mia-Ajuda, (1) você possui ou tem o direito de postar tal Conteúdo e (2) tal Conteúdo, ou a sua utilização pelo Mia-Ajuda, conforme prevista pelos acordos, não viola os Acordos nem quaisquer outros direitos estabelecidos nas Diretrizes do Usuário, na lei aplicável, ou nos direitos de liberdade de expressão, de personalidade ou outros direitos de terceiros.

O Mia-Ajuda pode, mas não tem a obrigação de, monitorar, revisar ou editar o Conteúdo. Em todos os casos, o Mia-Ajuda se reserva o direito de remover ou desabilitar o acesso a qualquer Conteúdo, por qualquer motivo, incluindo Conteúdo que, a critério exclusivo do Mia-Ajuda, viole os Acordos. O Mia-Ajuda pode tomar essas ações sem notificação prévia para você ou qualquer terceiro. Remover ou desabilitar o acesso ao Conteúdo será de nosso exclusivo critério, e não prometemos remover ou desabilitar o acesso a qualquer Conteúdo específico.

Você é exclusivamente responsável por todos os Conteúdos que você postar. O Mia-Ajuda não é responsável pelo Conteúdo nem endossa qualquer opinião contida em qualquer Conteúdo. VOCÊ CONCORDA QUE, CASO ALGUÉM MOVA AÇÃO CONTRA O MIA-AJUDA RELACIONADA AO CONTEÚDO QUE VOCÊ POSTAR, NA MEDIDA DO PERMITIDO PELA LEI LOCAL, VOCÊ INDENIZARÁ E MANTERÁ O MIA-AJUDA COMO INDENE POR QUAISQUER DANOS, PERDAS E DESPESAS DE QUALQUER TIPO (INCLUINDO CUSTOS E HONORÁRIOS ADVOCATÍCIOS RAZOÁVEIS) DECORRENTES DE TAL AÇÃO.

## 5.Diretrizes de Usuário

Estabelecemos regras para o uso do serviço. Você concorda em seguir e incentivar outros usuários a seguir essas regras. É proibido, por qualquer motivo:

* utilizar o serviço Mia-Ajuda para qualquer finalidade que não seja “fazer e atender pedidos de ajuda”;
* usar o Mia-Ajuda enquanto cadastrado com a conta de outra pessoa;
* permitir que outra pessoa utilize o Mia-Ajuda enquanto cadastrado com a sua conta;
* realizar cadastro no Mia-Ajuda usando dados (Nome, CPF etc) falsos ou pertencentes a outra pessoa, ou seja, não verdadeiros para o usuário;
* contornar qualquer tecnologia utilizada pelo Mia-Ajuda, ou por terceiros para proteger o Conteúdo ou o Serviço;
* vender, alugar, sublicenciar ou locar qualquer parte do Serviço Mia-Ajuda ou do conteúdo por ele disponibilizado;
* fornecer sua senha para qualquer outra pessoa ou usar o nome de usuário e senha de qualquer outra pessoa;
* artificialmente criar ou publicar conteúdo por meios automatizados ou de qualquer forma;
* realizar "crawling" do Serviço Mia-Ajuda ou diferentemente usar quaisquer meios automatizados (incluindo bots, scrapers e spiders) para visualizar, acessar ou coletar informações do Mia-Ajuda;
* reutilizar, publicar conteúdo retirado do Mia-Ajuda;
...
* ilegal, ou que se destine a promover ou cometer ato ilegal de qualquer natureza, incluindo as violações de direitos de propriedade intelectual, direitos de privacidade ou direitos de propriedade do Mia-Ajuda ou de terceiros;
...
* que envolva atividades comerciais ou de vendas, como publicidade, promoções, concursos, sorteios ou esquemas de pirâmide, que não são expressamente autorizadas pelo Mia-Ajuda;
* que faça link ou referências a ou que de qualquer forma promova produtos ou serviços comerciais, exceto quando expressamente autorizado pelo Mia-Ajuda;
* que interfira no ou de qualquer forma interrompa o Serviço Mia-Ajuda, manipule, viole ou tente sondar, varrer ou testar a vulnerabilidade do Mia-Ajuda ou dos sistemas de computador, rede e regras de uso do Mia-Ajuda, ou qualquer componente de segurança do Mia-Ajuda, medidas de autenticação ou quaisquer outras medidas de proteção aplicáveis ao Serviço, ao Conteúdo ou a qualquer parte dos mesmos; ou
* que conflite com os Acordos, conforme determinado pelo Mia-Ajuda.

Você reconhece e concorda que postar qualquer Conteúdo de Usuário que viole estas Diretrizes de usuário (ou que o Mia-Ajuda razoavelmente acredita violar as Diretrizes de usuário) pode resultar na imediata rescisão ou suspensão de sua conta do Mia-Ajuda. Você concorda, ainda, que o Mia-Ajuda pode reivindicar seu nome de usuário quando for razoável para nós, inclusive caso você tenha violado os Acordos.

O Mia-Ajuda não se responsabiliza pela sua decisão de postar material utilizando o Serviço.


## 6.Denúncia de Conteúdo de  Usuário

Conteúdo de Usuário que você acredita violar as diretrizes de usuário deve ser reportado para o time do Mia-Ajuda.

## 7.Limitações e Modificações do Serviço

Para que sejam efetuadas melhorias, atualizações ou em casos de problemas técnicos, o Mia-Ajuda se reserva o direito de, periodicamente e a qualquer momento, modificar ou descontinuar, temporária ou permanentemente, funções e recursos do Serviço, mesmo sem notificações antecedentes, sem incutir responsabilidades a você.

## 8.Contas de Marca

Se você estabelecer uma conta no Mia-Ajuda em nome de uma empresa, organização, pessoa jurídica ou marca (uma "Marca" e, a aludida conta, uma "Conta de Marca"), os termos "você" e "seu", conforme usado ao longo dos Acordos, se aplicam tanto a você quanto à Marca. Se você criar uma Conta de Marca, você declara e garante que está autorizado a conceder todas as permissões e licenças previstas nos Acordos e vincular a Marca aos Acordos e não irá utilizar o Mia-Ajuda como ferramenta de marketing ou para qualquer fim que viole as Diretrizes de Usuário.

## 9.Aviso de Garantia

Você entende e concorda que o serviço Mia-Ajuda é fornecido “como está” e “conforme disponíveis”, sem garantia expressa ou implícita ou condição de qualquer tipo. O Mia-Ajuda não faz qualquer declarações e se isenta de quaisquer garantias ou condições de qualidade satisfatória. O Mia-Ajuda não garante que o serviço ou qualquer conteúdo criado por usuários é livre de malware ou outros componentes prejudiciais ou explícitos.

O Mia-Ajuda não é responsável por qualquer Conteúdo, qualquer interação ou informação, trocada entre usuários, através ou independentemente do Serviço.

## 10.Direitos que você concede a nós

Em contraprestação aos direitos concedidos a você pelos Acordos, você nos concede o direito de permitir que o aplicativo Mia-Ajuda use o hardware processador, de banda larga e armazenamento do seu dispositivo para facilitar a operação do aplicativo.

Se você fornecer feedback, ideias ou sugestões para o Mia-Ajuda relacionados ao aplicativo ou Conteúdo ("Feedback"), você reconhece que o Feedback não é confidencial e você autoriza ao Mia-Ajuda  a usar esse Feedback sem restrições e sem pagamentos a você. O Feedback é considerado um tipo de Conteúdo.

Você também concorda em renunciar e não impor quaisquer "direitos morais" ou direitos equivalentes, como o direito de ser identificado como autor de qualquer Conteúdo, incluindo o Feedback e seu direito de se opor ao tratamento depreciativo de tal Conteúdo.

## 11.Limitações

Você concorda que o seu único e exclusivo recurso para quaisquer problemas ou qualquer insatisfação com os serviços do Mia-Ajuda é desinstalar o aplicativo e parar de usar o aplicativo. Seu único e exclusivo recurso, no que diz respeito ao Mia-Ajuda, para quaisquer problemas ou qualquer insatisfação com o aplicativo ou o Conteúdo do mesmo, é desinstalar e/ou parar de usar tal aplicativo.

## 12.Direitos de Terceiros

Você reconhece e concorda que os proprietários do Conteúdo e outros usuários são beneficiários dos Acordos e têm o direito de fazer cumprir os Acordos diretamente contra você. Diferente do previsto na presente seção, os acordos não se destinam a conceder direitos a ninguém, exceto você e o Mia-Ajuda, e em nenhum caso, os Acordos criarão quaisquer direitos de terceiros beneficiários. Além disso, os direitos de encerrar, rescindir ou concordar com qualquer variação, renúncia, ou liquidação dos Acordos não são sujeitos à autorização de qualquer outra pessoa.

## 13.Íntegra do Acordo

Exceto conforme indicado nesta seção ou conforme explicitamente acordado por escrito entre você e o Mia-Ajuda, os Acordos constituem todos os termos e condições acordados entre você e o Mia-Ajuda e suplantam quaisquer acordos prévios em relação ao objeto desses Acordos, sejam escritos ou verbais.
...
Qualquer falha por parte do Mia-Ajuda ou qualquer terceiro beneficiário em fazer valer os Acordos ou qualquer uma de suas disposições não renunciarão o direito do Mia-Ajuda ou do respectivo terceiro beneficiário de fazê-lo.
...
O Mia-Ajuda pode ceder os Acordos e quaisquer direitos do Mia-Ajuda ao abrigo dos Acordos, no todo ou em parte. O Mia-Ajuda pode delegar quaisquer obrigações suas ao abrigo dos Acordos. Você não pode ceder os Acordos, no todo ou em parte, nem transferir ou sublicenciar seus direitos ao abrigo dos Acordos, a qualquer terceiro.

## 16.Indenização

Você concorda em indenizar e manter o Mia-Ajuda indene contra todos os danos, perdas e despesas de qualquer natureza (incluindo custos e honorários advocatícios razoáveis) decorrentes de ou relacionados com: (1) violação, de sua parte, dos Acordos ou qualquer um desses; (2) qualquer Conteúdo de Usuário que você postar ou com o qual contribuiu; (3) qualquer atividade na qual você se envolva no ou através do Serviço Mia-Ajuda; e (4) violação, de sua parte, de qualquer lei ou dos direitos de terceiros.

## 17.Eleição do foro, arbitragem obrigatória e juízo
#### 17.1 Lei / Jurisdição Regentes
A menos que diferentemente exigido por lei compulsória ou por qualquer outra jurisdição, os Acordos (e quaisquer disputas/demandas extracontratuais decorrentes de ou em conexão com esses) estarão sujeitos às leis do estado ou país listado abaixo, sem considerar a escolha ou os conflitos de princípios de direito.

Ainda, você e o Mia-Ajuda concordam com a jurisdição dos tribunais listados abaixo para dirimir qualquer disputa, reivindicação ou controvérsia advinda no âmbito dos Acordos (e quaisquer disputas/demandas extracontratuais decorrentes de ou em conexão com os mesmos).
...
QUANDO PERMITIDO PELA LEI APLICÁVEL, VOCÊ E O MIA-AJUDA CONCORDAM QUE CADA UM PODERÁ MOVER AÇÕES CONTRA O OUTRO APENAS EM SUA CAPACIDADE INDIVIDUAL E NÃO COMO UM AUTOR OU MEMBRO DE CLASSE EM QUALQUER AÇÃO COLETIVA OU REPRESENTATIVA. A menos que você e o Mia-Ajuda concordem, nenhum árbitro ou juiz poderá consolidar reivindicações de mais de uma pessoa ou presidir sobre qualquer forma processo representativo ou de classe.

#### 17.3 Arbitragem

Se você estiver localizado, baseado, possuir escritórios ou realizar negócios em uma jurisdição na qual esta Seção 17.3, é exequível, as disposições de arbitragem obrigatória a seguir se aplicam a você:
17.1 Lei / Jurisdição Regentes
