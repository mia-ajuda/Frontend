const acceptHelpRequestRecommendationsDescription = `
...
const createHelpOfferedRecommendationsDescriptions = `
...
const helpOfferedRecommendations = [
    {
        id: '1',
        title: 'Recomendações importantes para aceitar um pedido de ajuda',
        description: acceptHelpRequestRecommendationsDescription,
    },
    {
        id: '2',
        title: 'Recomendações importante para oferecer ajuda',
        description: createHelpOfferedRecommendationsDescriptions,
    },
];

export default helpOfferedRecommendations;
