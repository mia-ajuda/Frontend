const acceptHelpOfferRecommendationsDescription = `
...
const createHelpRequestRecommendationsDescriptions = `
...
const helpRequestRecommendations = [
    {
        id: '1',
        title: 'Recomendações importantes para se interessar por alguma oferta de ajuda',
        description: acceptHelpOfferRecommendationsDescription,
    },
    {
        id: '2',
        title: 'Recomendações importantes para criar de pedidos de ajuda ',
        description: createHelpRequestRecommendationsDescriptions,
    },
];

export default helpRequestRecommendations;
